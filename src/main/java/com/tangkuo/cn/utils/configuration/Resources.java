...
public class Resources {
  ...
  public static String getResourceMessageByKey(String key) {
		//Locale locale = LocaleContextHolder.getLocale();
		String value;

		try {
			value = ResourceBundle.getBundle("ApplicationResources")
					.getString(key);
  ...
  public static String getResourceMessageByKey(String bundleName, String key) {
	  String value = null;
