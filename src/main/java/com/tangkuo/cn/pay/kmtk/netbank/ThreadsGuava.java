 ...
 * @Description: (线程相关工具类)
 * @author tangkuo
 * @date 2017年6月27日 下午2:23:55
 * @since JDK 1.7
 */
public class ThreadsGuava {

	private static Logger logger = LoggerFactory.getLogger(ThreadsGuava.class);
	 ...
	 */
	public static boolean gracefulShutdown(ExecutorService threadPool, int shutdownTimeoutMills, TimeUnit timeUnit) {
		return MoreExecutors.shutdownAndAwaitTermination(threadPool, shutdownTimeoutMills, timeUnit);
	}
