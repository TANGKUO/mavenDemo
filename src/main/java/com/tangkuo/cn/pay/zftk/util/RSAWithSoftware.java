...
import com.tangkuo.cn.pay.zftk.jar.Base64;

/**
 * 
* @ClassName: RSAWithSoftware
* @Description: (软件证书RSA加密,公私钥方法)
* @author tangkuo
* @date 2017年7月9日 下午7:56:32
*
 */
