...
public class HttpPostMap {
	...
	private static int httpTimeOut = 100000;;
	 ...
	 * @param URL:请求地址
	 * @param params：请求参数
	 * @param pathFlat：false-为http请求，true为https请求
	 * @return 返回json格式字符串
	 */
	public static String post(String URL, Map<String, String> params, boolean pathFlat)
